...
* Before the accepted students are announced, the community should sign the [Community Cooperation Agreement](assets/2023-OPEN-SOURCE-PROMOTION-PLAN-COOPERATION-AGREEMENT-Template.docx), which should specify the number, name, difficulty, and bonus amount of the community-supported projects. 
...
* If the community wants to support projects, they should sign a [Community Cooperation Agreement](assets/2023-OPEN-SOURCE-PROMOTION-PLAN-COOPERATION-AGREEMENT-Template.docx) with the organizing committee before the accepted students are announced.
...
* If the community needs to change account information, modify community introductions, project descriptions, or change mentors, please send an application email to [org@summer-ospp.ac.cn](mailto:org@summer-ospp.ac.cn) and submit an [Information Modification Application Form](https://summer-ospp.ac.cn/help/assets/%E7%A4%BE%E5%8C%BA%E4%BF%A1%E6%81%AF%E4%BF%AE%E6%94%B9%E7%94%B3%E8%AF%B7%E8%A1%A8-Community-Information-Modification.xlsx). The organizing committee does not recommend modifying relevant information after the announcement, so please carefully check and confirm before publishing.

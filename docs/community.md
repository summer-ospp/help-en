...
- Before the announcement of selected results in the projects, the community should sign the [Community Cooperation Agreement](https://github.com/summer-ospp/help/blob/2024/docs/assets/OPEN-SOURCE-PROMOTION-PLAN-COOPERATION-AGREEMENT-Template.docx)  with the committee, detailing the quantity, names, difficulty, and bonus amounts of the community-supported projects. The agreement should be downloaded and uploaded to the system.

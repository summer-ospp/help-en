...
* During the Project Release phase, the community can submit projects in the system based on their needs(the number of projects is not limited). Approved projects will be gradually published on the official website. 
...
* Please refer to the mentor guide for mentor responsibilities, which include but are not limited to:
  ...
  * Metoringing students in the development process.

...
- If you are a student, see student guide.
- If you are a community, see community guide.
- If you are a community mentor, see mentor guide.
...
Please refer to  for details of [student participation](student.md). *Note: the default time zone 'GMT + 8'*
...
Yes, pr merged into the main line is the most important criterion to determine the project closure.
...
2. By the end of the project development (i.e. by 9/30) , students need to submit pr to the community and submit their final report to Open Source Promotion Plan Management System;
